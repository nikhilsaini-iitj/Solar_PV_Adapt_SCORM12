...
- 3D virtual lab includes exploded view of module layers, technology switcher, and live output simulation
...
- **Interactive storyboard diagrams**: rooftop system energy flow (day/night) and exploded panel layer explorer
